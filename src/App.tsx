            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 items-start gap-6">
              ...
              <div className="glass-card p-6 lg:col-span-2">
                ...
                <div className="space-y-4">
                  <div>
                    <DraggableTeamList 
                      teams={tempSettings.teamOrder || DEFAULT_TEAM_ORDER}
                      onChange={(newOrder) => setTempSettings({ ...tempSettings, teamOrder: newOrder, teamOrderVersion: DEFAULT_TEAM_ORDER_VERSION })}
                    />
                  ...
                  <div className="flex justify-end">
                    <button 
                      onClick={() => setTempSettings({ ...tempSettings, teamOrder: DEFAULT_TEAM_ORDER, teamOrderVersion: DEFAULT_TEAM_ORDER_VERSION })}
